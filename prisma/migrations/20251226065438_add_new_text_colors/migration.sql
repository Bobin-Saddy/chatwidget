...
INSERT INTO "new_ChatSettings" ("createdAt", "headerBgColor", "headerSubtitle", "headerTextColor", "headerTitle", "heroBgColor", "heroTextColor", "id", "launcherIcon", "primaryColor", "replyTimeText", "shop", "startConversationText", "updatedAt", "welcomeImg", "welcomeSubtext", "welcomeText") SELECT "createdAt", "headerBgColor", "headerSubtitle", "headerTextColor", "headerTitle", "heroBgColor", "heroTextColor", "id", "launcherIcon", "primaryColor", "replyTimeText", "shop", "startConversationText", "updatedAt", "welcomeImg", "welcomeSubtext", "welcomeText" FROM "ChatSettings";
